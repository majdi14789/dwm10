SELECT address.c_address_zipcode, to_date(point.c_actualarrival, 'DAY') as daychar, count(*)
...
GROUP BY address.c_address_zipcode, to_date(point.c_actualarrival, 'DAY')
ORDER BY count(*) DESC;
